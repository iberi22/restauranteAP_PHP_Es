			  ...
			  <tbody>
				  	<?php
						...
						foreach ($cur as $result) {
				  		...
				  		echo '<td><a title="edit" href="../admin/products/index.php?view=edit&id='.$result->PROID.'">'.$result->PRONAME.' [' . $result->PROMODEL.']</a></td>';
				  		...
				  		echo
				  		 '<td align="left">
							<a href="../admin/settings/controller.php?action=editStatus&id='.$result->PROID.'&stats='.$stats.'" class="btn btn-primary btn-xs">'.$stats.'</a>
