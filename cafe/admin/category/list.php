...
?>
	<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Lista de categorias  <a href="index.php?view=add" class="btn btn-primary btn-s  ">  <i class="fa fa-plus-circle fw-fa"></i> Crear Categoria</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
				  ...
				  <thead>
				  	<tr>
				  		...
				  		<th style="font-size: 15px;">
				  		 ...
				  		 Categoria</th>
				  		 <th width="25%" style="text-align: center; font-size: 15px;">Acciones</th>
				  	</tr>
				  </thead>
				  <tbody>
				  	<?php
