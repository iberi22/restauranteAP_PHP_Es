    	...
    	<div class="col-lg-12">
    		<div class="row">
    			<div class="page-header">
    				Listado de Ordenes <a href="addorder.php" class="btn-primary btn btn-s" data-toggle="lightbox" data-title="New Order"><i class="fa fa-plus-circle"></i> Nueva Orden</a>
    			</div>
