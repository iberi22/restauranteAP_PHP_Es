...
<body>
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <img src="login/01.png" id="icon" alt="User Icon" />
             <!-- <span>ADMIN</span> -->
            </div>
            <!-- Login Form -->
            <form  action="#" method="post">
                <input name="user_email" placeholder="Nombre de usuario"  type="text" value=""  class="fadeIn second">
                <input type="password" id="password" class="fadeIn third" name="user_pass" placeholder="password">
